...
class Send(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            if message == 'QUIT':
                self.sock.sendall('Servidor: {} tiene un chat.'.format(self.name).encode('ascii'))
                break
...
class Client:
    ...
    def start(self):
        ...
        print('Tratando de conectar {}:{}...'.format(self.host, self.port))
        self.sock.connect((self.host, self.port))
        print('Conexion establecida {}:{}'.format(self.host, self.port))
        
        print()
        self.name = input('Your name: ')

        print()
        print('Bienvenido, {}! Leer o enviar mensajes..'.format(self.name))
        ...
        self.sock.sendall('Server: {} hola'.format(self.name).encode('ascii'))
        print("\rHolaaa'\n")
        print('{}: '.format(self.name), end = '')
...
def main(host, port):
    ...
    text_input.insert(0, "Aqui su mensaje.")
